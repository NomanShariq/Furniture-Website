			...
			case 'success':
				?>
					<div class="astra-pro-sites-success-message">
						<p><?php esc_html_e( 'Congratulations! You have activated your Starter Templates License key successfully — A world of beautiful templates awaits.', 'astra-sites' ); ?></p>
					</div>
					<?php
				break;
