...
namespace ElementPack\Modules\BbpressSingleTag\Widgets;
...
class Bbpress_Single_Tag extends Module_Base {

	public function get_name() {
		return 'bdt-bbpress-single-tag';
	}

	public function get_title() {
		return BDTEP . esc_html__('bbPress Single Tag', 'bdthemes-element-pack');
	}

	public function get_icon() {
		return 'bdt-wi-bbpress-single-tag';
	}
	...
	public function register_controls() {
		...
		$this->add_control(
			'bbpress_topic_tag_id',
			[
				'label'       => __('Topics Tags', 'bdthemes-element-pack'),
				'type'        => Dynamic_Select::TYPE,
				'label_block' => true,
				'placeholder' => __('Type and select tag', 'bdthemes-element-pack'),
				'query_args'  => [
					'query'        => 'bbpress_single_topic_terms',
				],
			]
		);
		// bbpress_single_topic_terms
	...
	public function content_archive_topic() {
...
<?php
	...
	public function render() {
		...
		bbp_set_query_name('bbp_topic_tag');
		bbpress()->current_topic_tag_id = $tag_id = $this->get_settings_for_display('bbpress_topic_tag_id');
		$this->content_archive_topic();
		wp_reset_postdata(  );
	}
}
