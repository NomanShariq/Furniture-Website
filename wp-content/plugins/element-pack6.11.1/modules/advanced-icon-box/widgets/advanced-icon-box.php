...
class Advanced_Icon_Box extends Module_Base {
	...
	protected function content_template() {
		?>
		<#
		view.addRenderAttribute( 'description_text', 'class', 'bdt-ep-advanced-icon-box-description' );

		view.addInlineEditingAttributes( 'title_text', 'none' );
		view.addInlineEditingAttributes( 'description_text' );

		view.addRenderAttribute( 'advanced-icon-box-title', 'class', 'bdt-ep-advanced-icon-box-title' );
		view.addRenderAttribute( 'advanced-icon-box-sub-title', 'class', 'bdt-ep-advanced-icon-box-sub-title' );
		view.addRenderAttribute( 'advanced-icon-box', 'class', 'bdt-ep-advanced-icon-box' );

		iconHTML = elementor.helpers.renderIcon( view, settings.selected_icon, { 'aria-hidden': true }, 'i' , 'object' );
		migrated = elementor.helpers.isIconMigrated( settings, 'selected_icon' );

		if ( 'yes' == settings.icon_inline && 'top' != settings.position ) {
			view.addRenderAttribute( 'advanced-icon-box-icon-heading', 'class', 'bdt-ep-advanced-icon-box-icon-heading bdt-flex bdt-flex-middle' );
		...
		<div <# print( view.getRenderAttributeString( 'advanced-icon-box' ) ); #>>
			...
			<div class="bdt-ep-advanced-icon-box-content">
				...
				<# if ( settings.readmore == 'yes' ) { #>
					<a id="{{ settings.button_css_id }}" class="bdt-ep-advanced-icon-box-readmore {{animation}}{{attention}}" href="{{ settings.readmore_link.url }}" {{onclick}}>
		...
		<# if ( settings.indicator === 'yes' ) { #>
			<div class="bdt-ep-advanced-icon-box-indicator bdt-svg-style-{{{settings.indicator_style}}}">
		...
		<# if ( settings.badge && settings.badge_text != '' ) { #>
			<div class="bdt-ep-advanced-icon-box-badge bdt-position-{{{settings.badge_position}}}">
