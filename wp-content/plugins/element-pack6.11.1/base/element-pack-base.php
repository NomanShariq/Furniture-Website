<?php
	...
	if ( ! class_exists( "Element_Pack_Base" ) ) {
		class Element_Pack_Base {
            ...
            $responseObj = (object) [ 'is_valid' => '1', 'expire_date' => '01.01.2030', 'support_end' => '01.01.2030', 'license_title' => 'Single License | NULLCave.club', 'license_key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', 'msg' => 'msg' ];
